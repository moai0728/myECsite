              ...
              <div>
                     ...
                     <tr>
                                   ...
                                   <td>
                                         ...
                                         <label class="user"><s:property value="session.user_name"/></label>
                                   </td>
                    </tr>
                    <tr>
                            <td>商品名</td>
                    ...
                    <tr>
                            ...
                            <td>
                                        ...
                                        <label class ="error"><s:property value="error" /></label>
                    ...
                    <tr>
                            ...
                            <td><input type="button"value="完了"onclick="submitAction('BuyCompleteAction')"/></td>
                    </tr>
                            </s:form>
